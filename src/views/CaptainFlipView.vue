...
<template>
	<div class="container">
		...
		<section  class="section section_video">
			...
			<iframe v-if="locale == 'fr'" width="560" height="315" src="https://www.youtube.com/embed/Vhpjz4tdzRQ?si=91JfUMW6gvwiAVMZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
			<iframe v-else width="560" height="315" src="https://www.youtube.com/embed/NTBDTN9mqtM?si=7MqBvjjZSC7aC42l" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
		</section>
		...
		<section class="section section7 expansionSection" id="kraken">
			...
			<div class="flexBoxContainer">
				<div class="text">
					...
					<div class="buttonContainer justifyLeft">
						<span class="downloadLink">
							<RouterLink :to="Tr.i18nRoute({ name: 'press', hash: '#CF' })">{{ $t('captainFlip.krakenDownload') }}</RouterLink>
						</span>
						<span class="purchaseLink">
							<a href="https://www.philibertnet.com/fr/playpunk/139851-captain-flip-dans-la-gueule-du-kraken-5430003838099.html" target="_blank" rel="noopener">
		...
		<section class="section section65 expansionSection">
			...
			<div class="flexBoxContainer">
				...
				<div class="text">
					...
					<div class="buttonContainer justifyLeft">
						<span class="downloadLink">
							<RouterLink :to="Tr.i18nRoute({ name: 'press', hash: '#CF' })">{{ $t('captainFlip.islaDownload') }}</RouterLink>
						</span>
						<span class="purchaseLink">
							<a href="https://www.philibertnet.com/fr/playpunk/170497-captain-flip-isla-bomba-5430003838341.html" target="_blank" rel="noopener">
								{{ $t('zenith.section7.purchaseButton')}}
							</a>
						</span>
					</div>
		...
		<section class="section8 section_goodies">
			<h1 class="title">{{ $t("captainFlip.goodies_title") }}</h1>
			<div class="non_title_container">
				<!-- FLIPPER -->
				<div class="flexbox_container">
						<img src="../assets/images/CF/Goodies/Flipper_tile.jpg" alt="flipper tile" class="goodie_img">
						<div class="buttonContainer smallGap">
							<span class="downloadLink">
								<RouterLink :to="Tr.i18nRoute({ name: 'flipper' })">{{ $t('captainFlip.flipper_rules_btn') }}</RouterLink>
							</span>
							<span class="purchaseLink">
								<a href="https://www.philibertnet.com/fr/playpunk/175969-captain-flip-dauphin-le-flipper-5430003838266.html" target="_blank" rel="noopener">
									{{ $t('zenith.section7.purchaseButton')}}
								</a>
							</span>
						</div>
				...
				<!-- BOTTLE -->
				<div class="flexbox_container">
						<img src="../assets/images/CF/Goodies/Bottle_tile.jpg" alt="bottle tile" class="goodie_img">
						<div class="buttonContainer smallGap">
							<span class="downloadLink">
								<RouterLink :to="Tr.i18nRoute({ name: 'bottle' })">{{ $t('captainFlip.bottle_rules_btn') }}</RouterLink>
							</span>
							<span class="purchaseLink">
								<a href="https://www.philibertnet.com/fr/playpunk/175970-captain-flip-bouteille-a-la-mer-5430003838488.html" target="_blank" rel="noopener">
									{{ $t('zenith.section7.purchaseButton')}}
								</a>
							</span>
						</div>
		...
		<section class="section9 section_BGA_PARK">
			<span class="title">{{ $t("captainFlip.BGA_PARK_title") }}</span>
			<div class="image_container">
				<a v-if="locale == 'fr'"	href="https://fr.boardgamearena.com/gamepanel?game=captainflip"><img class="image" src="../assets/images/home/bga.webp" alt="Board Game Arena logo"></a>
				<a v-else 					href="https://en.boardgamearena.com/gamepanel?game=captainflip"><img class="image" src="../assets/images/home/bga.webp" alt="Board Game Arena logo"></a>
				
				<a v-if="locale == 'fr'" 	href="https://game-park.com/fr/board-games/captain-flip"><img class="image" src="../assets/images/home/game-park-icon.svg" alt="Game Park logo"></a>
				<a v-else 					href="https://game-park.com/en/board-games/captain-flip"><img class="image" src="../assets/images/home/game-park-icon.svg" alt="Game Park logo"></a>
			</div>
		</section>
...
<style scoped lang="scss">
	...
	.section2 {
		...
		.rules {
			width: clamp(300px, 1000px, 100vw);
			display: flex;
	...
	@media screen and (max-width: 1000px) {
		.expansionSection > .flexBoxContainer {
			flex-direction: column;
			gap: 30px;
	...
	@media screen and (max-width: 1000px) {
		.section_goodies > .non_title_container {
			flex-direction: column;
		}
	}
